...
<body>
    ...
    <form action="{{ route('register') }}" method="POST" class="box">
        ...
        <div class="login area">
            <label for="user" class="form-control">Pilih User:</label>

            <label for="event" class="form-control">Pilih Acara:</label>

            <option value="" class="form-control">Pilih Lapak:</option>
            {{-- @for ($i = 1; $i <= 5; $i++)
