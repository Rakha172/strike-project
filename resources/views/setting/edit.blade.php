        ...
        <div class="container mt-5 border border-2">
            ...
            <form action="{{ route('setting.update', $setting->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label class="form-label">WhatsApp Media End Point</label>
                        <textarea name="media_endpoint" type="text" class="form-control @error('media_endpoint') is-invalid @enderror">{{ old('media_endpoint', $setting->media_endpoint) }}</textarea>
                        @error('media_endpoint')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
