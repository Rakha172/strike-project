...
<body>
    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-body">
                <h1 class="text-center fs-2 mt-4" style="background-color:#c5e3f1;">Hasil Result Pemancingan Operator
                </h1>
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                <div class="mb-3">
                                    ...
                                    <select name="participant" class="form-control" style="background-color:#c5e3f1;">
