...
<body>
    ...
    <form action="{{ route('password.email') }}" method="POST" class="box">
        ...
        <div class="header">
            ...
            <p>Masukan Masukan Password baru</p>
        </div>
        <div class="login area">
            ...
            <input type="email" name="email"  class="email @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="Masukkan password baru" required>
            @error('email')
